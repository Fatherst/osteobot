...
from keyboards.kb_client import get_thecure, get_osteodiagn, get_osteoncovid, get_startinline, get_osteoclass, \
    get_reasons_osteo, get_whatis_osteo, get_time, get_kazan, get_cities, get_ques_ans
...
async def start_command(message: types.Message):
    await bot.send_photo(message.chat.id,
                         photo="AgACAgIAAxkBAAEaqExjjeIXrrRSW6shq6S_JQRopY7WdAACXcIxG0eYcEhT6rnHPLiUoQEAAwIAA3gAAysE",
...
async def whatis(callback: types.CallbackQuery):
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqTxjjfdb5nf3QzfhITODgKTtfolPtQACcsIxG0eYcEgt4dNF-_j2ewEAAwIAA3kAAysE",
...
async def reasons(callback: types.CallbackQuery):
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqU1jjfl_wLvSNXrangqLrVFji53TyQACa8IxG0eYcEgmm9zRpRshzAEAAwIAA3kAAysE",
...
async def diagnosis(callback: types.CallbackQuery):
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqbZjjgABrsV-_MAeodKUFi-5COJ8N7kAAm3CMRtHmHBIMDhfQNNXghwBAAMCAAN5AAMrBA",
    ...
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqbhjjgABvkQZNBtd8N6hQF31nTIn004AAmnCMRtHmHBI-bX0lus8nDcBAAMCAAN4AAMrBA",
    ...
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqbpjjgABy8oEAZ3I-Y3dx_66scywnqAAAm7CMRtHmHBIPrySZaRJL3gBAAMCAAN4AAMrBA",
...
async def thecure(callback: types.CallbackQuery):
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqZxjjf136rO41JDmi9twlzCnwbTZcQACccIxG0eYcEhMc6t-JRfVNwEAAwIAA3kAAysE",
    ...
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqZpjjf13bGUQs0BdIljWoLsEzMHZsQACbMIxG0eYcEi_TC4WIMBp9wEAAwIAA3gAAysE",
    ...
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqZtjjf13Izctt6vOf521MlFMh3qoRQACb8IxG0eYcEgD-Ww9wQ_6LgEAAwIAA3kAAysE",
...
async def classific(callback: types.CallbackQuery):
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqV5jjfptz7zUl177yUEpKx-XDqIkEAACcMIxG0eYcEhDxbf25TkAARQBAAMCAAN5AAMrBA",
                         reply_markup=get_osteoclass())


async def osteoncovid(callback: types.CallbackQuery):
    await bot.send_photo(callback.message.chat.id,
                         photo="AgACAgIAAxkBAAEaqVdjjfpZDeSTWHBuNzeVLBYr3aYX2QACasIxG0eYcEh58lKuaKKJ0gEAAwIAA3kAAysE",
...
def register_handlers_client(dp: Dispatcher):
    ...
    dp.register_message_handler(asked_ques, content_types=['text'], state=FSMquestion)
